...
public final class ItemUtil {
	...
	public static void setType(Entity meta, String type) {
		ItemUtil.setString(meta, ItemUtil.ITEM_ID_KEY, type);
	}
	
	public static void setString(Entity meta, NamespacedKey key, String value) {
		meta.getPersistentDataContainer().set(
				key, 
				PersistentDataType.STRING, 
				value
	...
	public static void setInteger(Entity meta, NamespacedKey key, int value) {
		meta.getPersistentDataContainer().set(
				key, 
				PersistentDataType.INTEGER, 
				value
	...
	public static void setBoolean(Entity meta, NamespacedKey key, boolean value) {
		meta.getPersistentDataContainer().set(
				key, 
				PersistentDataType.BOOLEAN, 
				value
	...
	public static String getType(Entity meta) {
		return meta.getPersistentDataContainer().get(ItemUtil.ITEM_ID_KEY, PersistentDataType.STRING);
	}
	public static String getString(Entity meta, NamespacedKey key) {
		return meta.getPersistentDataContainer().get(key, PersistentDataType.STRING);
	}
	
	public static int getInteger(Entity meta, NamespacedKey key) {
		return meta.getPersistentDataContainer().get(key, PersistentDataType.INTEGER);
	}
	
	public static boolean getBoolean(Entity meta, NamespacedKey key) {
		return meta.getPersistentDataContainer().get(key, PersistentDataType.BOOLEAN);
	}
